<template>
  <el-col :span="24" :lg="24" class="flex justify-between">
    <!-- <div>
    ...
    <div class="w-full" v-if="featuredHotelsRooms.hotel">
      <top-bar icon="i-mdi-building" :city="featuredHotelsRooms.hotel.city_name" header="Featured Hotels"
        toPath="/FeaturedHotels" :title="$route.params.name"></top-bar>
    </div>
...
export default {
  computed: {
    ...mapState("featuredHotels", ["featuredHotelsRooms","featuredHotelsLoader"])
  },
  methods: {
