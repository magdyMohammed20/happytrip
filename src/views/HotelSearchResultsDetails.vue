<template>
        ...
        <el-col :lg="12" class="h-full w-full">
          <el-row class="h-full w-full">
            <el-col
              :lg="12"
              class="lg:h-[50%]"
              v-for="(img, index) in hotelImages?.slice(0, 4)"
              :key="index"
            >
              <img
                :src="img.Links[0].ProviderHref"
        ...
        <el-col :lg="12" class="h-full w-full">
          <el-row class="h-full w-full">
            <el-col
              :lg="index == 0 ? 24 : 8"
              class="lg:h-[50%]"
              v-for="(img, index) in hotelImages?.slice(4, 7)"
              :key="index"
            >
              <img
                :src="img.Links[0].ProviderHref"
  ...
  <hotel-images-slide v-if="showGallery" v-model="showGallery" :images="hotelImages.map(el=>el.Links[0].ProviderHref)">
...
export default {
  ...
  computed: {
    ...mapState("hotels", ["availbleHotelsDetails", "roomsLoader"]),
    hotelImages() {
