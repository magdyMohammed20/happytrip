  ...
  >
    <div>
      <p class="font-bold pt-5 mt-1 text-basic px-1">
        {{ availbleHotels.hotelsCount }} Hotel Search Result
      </p>
    </div>
    <div v-for="(card, index) in availbleHotels.hotels" :key="card.id">
      <el-card :body-style="{ padding: '0px' }" class="my-5 sm:px-3 lg:md:px-0">
        <div
          class="flex lg:md:justify-between sm:justify-around sm:flex-col lg:md:flex-row"
        >
          <div>
            <img
              :src="card.minImage"
    ...
    <el-pagination
      ...
      :total="this.availbleHotels.hotelsCount"
